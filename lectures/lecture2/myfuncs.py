...
# Returns an approximation for ln(x!)
# Only necessary when calculating equations containing large x!
def stirlingApprox(x):
    return x * logBase2Approx(x) - x + .5*logBase2Approx(2*PI*x)
